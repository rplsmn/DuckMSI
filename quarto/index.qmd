...
// Display results
{
  ...
  // Convert rows array back to array of objects for proper table display
  ...
  // Use Observable's built-in table display with custom styling
  return html`<div class="results-container">
    ${Inputs.table(data, {
      rows: 50,
      layout: "auto",
      format: {
        // Format all columns to handle null values
        ...Object.fromEntries(
